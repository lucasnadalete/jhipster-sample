...
import br.com.iacit.domain.Employee;
import br.com.iacit.domain.enumeration.Language;
import br.com.iacit.repository.EmployeeRepository;
import br.com.iacit.service.dto.EmployeeDTO;
import br.com.iacit.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_LIKED_IN = "AAAAAAAAAA";
    private static final String UPDATED_LIKED_IN = "BBBBBBBBBB";
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getLikedIn()).isEqualTo(DEFAULT_LIKED_IN);
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].likedIn").value(hasItem(DEFAULT_LIKED_IN)))
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.likedIn").value(DEFAULT_LIKED_IN))
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getLikedIn()).isEqualTo(UPDATED_LIKED_IN);
