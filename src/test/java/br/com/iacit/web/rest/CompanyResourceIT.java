...
import br.com.iacit.domain.Company;
import br.com.iacit.domain.enumeration.Language;
import br.com.iacit.repository.CompanyRepository;
import br.com.iacit.service.dto.CompanyDTO;
import br.com.iacit.service.mapper.CompanyMapper;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).cnpj(DEFAULT_CNPJ).language(DEFAULT_LANGUAGE);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).cnpj(UPDATED_CNPJ).language(UPDATED_LANGUAGE);
        return company;
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).language(UPDATED_LANGUAGE);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.cnpj(UPDATED_CNPJ).language(UPDATED_LANGUAGE);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).language(UPDATED_LANGUAGE);
