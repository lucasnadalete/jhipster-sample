  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="iacitSampleApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="iacitSampleApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="country-id"
                  label={translate('iacitSampleApp.country.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('iacitSampleApp.country.name')} id="country-name" name="name" data-cy="name" type="text" />
