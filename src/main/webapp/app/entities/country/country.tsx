  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="iacitSampleApp.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="iacitSampleApp.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="iacitSampleApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="iacitSampleApp.country.id">Id</Translate>
                </th>
                <th>
                  <Translate contentKey="iacitSampleApp.country.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="iacitSampleApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
