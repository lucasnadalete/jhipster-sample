  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="iacitSampleApp.city.home.createOrEditLabel" data-cy="CityCreateUpdateHeading">
            <Translate contentKey="iacitSampleApp.city.home.createOrEditLabel">Create or edit a City</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="city-id"
                  label={translate('iacitSampleApp.city.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('iacitSampleApp.city.name')} id="city-name" name="name" data-cy="name" type="text" />
