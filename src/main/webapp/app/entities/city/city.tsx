  ...
  return (
    <div>
      <h2 id="city-heading" data-cy="CityHeading">
        <Translate contentKey="iacitSampleApp.city.home.title">Cities</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="iacitSampleApp.city.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="iacitSampleApp.city.home.createLabel">Create new City</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cityList && cityList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="iacitSampleApp.city.id">Id</Translate>
                </th>
                <th>
                  <Translate contentKey="iacitSampleApp.city.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="iacitSampleApp.city.home.notFound">No Cities found</Translate>
            </div>
          )
        )}
      </div>
